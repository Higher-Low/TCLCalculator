...
export default function Home() {
  ...
  const calculations = useMemo(() => {
    ...
    // Profit calculations
    const calculateProfit = (entry: number, tp: number, qty: number) => {
    ...
    <div className='main'>
      ...
      <div>
        ...
        <div className='positions'>
          ...
          <div>
            {calculations.autoEntry} <CopyButton value={calculations.autoEntry} />
          </div>
          <div>
            {calculations.autoQty} <CopyButton value={calculations.autoQty} />
          </div>
          <div>
            {calculations.autoTp} <CopyButton value={calculations.autoTp} />
          </div>
          ...
          <div>
            {calculations.autoL1Entry} <CopyButton value={calculations.autoL1Entry} />
          </div>
          <div>
            {calculations.autoL1Qty} <CopyButton value={calculations.autoL1Qty} />
          </div>
          <div>
            {calculations.autoL1Tp} <CopyButton value={calculations.autoL1Tp} />
          </div>
          ...
          <div>
            {calculations.autoL2Entry} <CopyButton value={calculations.autoL2Entry} />
          </div>
          <div>
            {calculations.autoL2Qty} <CopyButton value={calculations.autoL2Qty} />
          </div>
          <div>
            {calculations.autoL2Tp} <CopyButton value={calculations.autoL2Tp} />
          </div>
          ...
          <div>
            {calculations.autoSl} <CopyButton value={calculations.autoSl} />
          </div>
        ...
        <Image src='/image.png' alt='Trading chart 1' width={1000} height={500} />
        <Image src='/image2.png' alt='Trading chart 2' width={1000} height={500} />
        ...
        <p>
          High: <span id='high'>{formData.high}</span>
        </p>
        <p>
          Low: <span id='low'>{formData.low}</span>
        </p>
        <hr />
        ...
        <hr />
        <p>
          Direction: <span id='direction'>{formData.direction}</span>
        </p>
        <p>
          Account Size: <span id='accountSize'>{formData.accountSize}</span>
        </p>
        <p>
          Risk: <span id='risk'>{formData.risk}</span>
        </p>
        <p>
          Risk Reward: <span id='riskReward'>{calculations.riskReward}</span>
        </p>
        <p>
          Leverage: <span id='leverage'>{formData.leverage}</span>
        </p>
        <p>
          Manage 1: <span id='manage1'>{formData.manage1}</span>
        </p>
        <p>
          Manage 2: <span id='manage2'>{formData.manage2}</span>
        </p>
        <hr />
